            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons">account_box</i>Emp Password Recovery</a></li>
					   ...
					   <li class="no-padding"><a class="waves-effect waves-grey" href="projectmanager/"><i class="material-icons">account_box</i>ProjectManager Login</a></li>
					   <li class="no-padding"><a class="waves-effect waves-grey" href="md/"><i class="material-icons">account_box</i>Managing Director Login</a></li>
					   <li class="no-padding"><a class="waves-effect waves-grey" href="projecthead/"><i class="material-icons">account_box</i>Project Head Login</a></li>
