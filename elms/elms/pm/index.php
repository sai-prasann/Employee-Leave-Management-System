...
$sql ="SELECT id,Emailid,Password FROM tblemployees WHERE Emailid=:uname and Password=:password and Department='Project Manager'";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Employee leave management system |  MD</title>
