...
$deptname=$_POST['EmployRole'];
$deptshortname=$_POST['EmployRoleShortName'];
$deptcode=$_POST['deptcode'];   
$sql="update tbldepartments set EmployRole=:deptname,DepartmentCode=:deptcode,EmployRoleShortName=:deptshortname where id=:did";
...
<input id="EmployRole" type="text"  class="validate" autocomplete="off" name="EmployRole" value="<?php echo htmlentities($result->EmployRole);?>"  required>
                                                <label for="deptname">Department Name</label>
                                            </div>


          <div class="input-field col s12">
<input id="EmployRoleShortName" type="text"  class="validate" autocomplete="off" value="<?php echo htmlentities($result->EmployRoleShortName);?>" name="EmployRoleShortName"  required>
