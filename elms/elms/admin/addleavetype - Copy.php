...
$sql="INSERT INTO tblleavetype(LeaveType,Description,TotalLeave) VALUES(:leavetype,:description,:tl)";
...
<textarea id="textarea1" name="tl" class="materialize-textarea" name="TotalLeave" length="500"></textarea>
<label for="deptshortname">Total Leave</label>
</div>
